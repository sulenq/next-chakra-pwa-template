...
export const DESKTOP_NAV_BTN_COLOR_PATELLE = "gray";
...
export const BACKDROP_FILTER_BLUR = `blur(${BLUR_RADIUS})`;

// Animation
export const BOUNCY_TRANSITION = "300ms cubic-bezier(0.175, 0.885, 0.32, 1.1)";
