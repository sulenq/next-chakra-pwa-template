  ...
  theme: {
    ...
    semanticTokens: {
      colors: {
        ...
        bgContent: {
          value: { base: "{colors.bg.subtle}", _dark: "#121212" },
        },
        bodytrans: {
        ...
        jade: {
          ...
          contrast: { value: "{colors.jade.900}" },
          fg: {
            value: { base: "{colors.jade.500}", _dark: "{colors.jade.300}" },
          },
          muted: {
            value: { base: "{colors.jade.200}", _dark: "{colors.jade.700}" },
          },
          subtle: {
