const translations = {
  ...
  "msg_chrome_permissions_settings_link": "Open browser settings → Privacy and Security → Site Settings → choose the permission you want to change.",
  "msg_deactivate": "The account will be deactivated and cannot be used temporarily.",
  "msg_default_permissions_settings_link": "Open browser settings and change the site permissions as needed.",
  "msg_edge_permissions_settings_link": "Open browser settings → Cookies and site permissions → choose the permission you want to change.",
  "msg_file_input_dropzone": "Drag and drop/click to upload files",
  "msg_firefox_permissions_settings_link": "Open browser settings → Privacy & Security → Permissions → change the required permission.",
