const translations = {
  ...
  msg_permissions_denied_helper:
    "If you want to grant access again, please open the site settings/app permissions in your browser, search for the related permission, and change its value manually there.",
  msg_permissions_granted_helper:
    "If you want to disable it, please open the site settings/app permissions in your browser, search for the related permission, and change its value manually there.",
  ...
  settings_accent_color_section: {
    title: "Accent color",
    description:
      "The primary color that defines the visual identity of the application.",
  },
  ...
  settings_auto_timezone: {
    ...
    description:
      "The application automatically adjusts the time zone based on the device location.",
    helper:
      "If disabled, the time zone will follow the manually selected user setting.",
  },
  ...
  settings_constrained_container_max_w: {
    title: "Max width",
    description:
      "Controls the maximum width of the application's main view. Min. 720",
  },
  ...
  settings_locale_section: {
    ...
    helper:
      "Language selection is only for the application UI, for content entered by the user it may be different depending on the language they choose/enter.",
  },
