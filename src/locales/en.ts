const translations = {
  ...
  "msg_reset_password_step_1_helper": "First step of forgot password, enter your email and we will send you an OTP to reset your password.",
  "msg_reset_password_step_2_helper": "Second step of forgot password, verify OTP",
  "msg_reset_password_step_3_helper": "Third step of forgot password, enter your new password",
