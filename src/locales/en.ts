const translations = {
  ...
  "msg_reset_password_step_1_helper": "First step, enter your email and we will send you an OTP to reset your password.",
  "msg_reset_password_step_2_helper": "Second step, verify OTP",
  "msg_reset_password_step_3_helper": "Third step, enter your new password",
