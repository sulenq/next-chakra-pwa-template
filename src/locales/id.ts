const translations = {
  ...
  msg_app_desc:
    "Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam inventore accusantium, libero exercitationem ipsum dolorem delectus iure dolorum quidem modi fugiat voluptate laborum cum laboriosam ullam commodi explicabo, magnam eius.",
  ...
  msg_permissions_denied_helper:
    "Jika ingin memberikan akses kembali, silakan buka setelan situs/izin aplikasi pada browser Anda, cari izin terkait, lalu ubah nilainya secara manual di sana.",
  msg_permissions_granted_helper:
    "Jika ingin menonaktifkannya, silakan buka setelan situs/izin aplikasi pada browser Anda, cari izin terkait, lalu ubah nilainya secara manual di sana.",
  ...
  settings_adaptive_dark_mode: {
    ...
    description:
      "UI mode gelap aktif saat malam hari ${timeRange} (waktu lokal)",
  },
  ...
  settings_auto_timezone: {
    ...
    description:
      "Aplikasi akan secara otomatis menyesuaikan zona waktu berdasarkan lokasi perangkat.",
    helper:
      "Jika dimatikan, zona waktu akan mengikuti pengaturan manual yang dipilih pengguna.",
  },
  ...
  settings_constrained_container_max_w: {
    ...
    description:
      "Mengatur batas lebar maksimum tampilan utama aplikasi. Min. 720",
  },
  ...
  settings_locale_section: {
    ...
    helper:
      "Pilihan bahasa hanya untuk UI aplikasi, untuk konten yang diinput oleh user mungkin akan berbeda tergantung bahasa yang mereka pilih/input.",
  },
