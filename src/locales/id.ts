const translations = {
  ...
  "msg_chrome_permissions_settings_link": "Buka pengaturan browser → Privasi dan Keamanan → Pengaturan Situs → pilih izin yang ingin diubah.",
  "msg_deactivate": "Akun akan dinonaktifkan dan tidak bisa digunakan sementara.",
  "msg_default_permissions_settings_link": "Buka pengaturan browser lalu ubah izin situs sesuai kebutuhan.",
  "msg_edge_permissions_settings_link": "Buka pengaturan browser → Cookie dan izin situs → pilih izin yang ingin diubah.",
  "msg_file_input_dropzone": "Drag and drop/klik untuk unggah berkas",
  "msg_firefox_permissions_settings_link": "Buka pengaturan browser → Privasi & Keamanan → Izin → ubah izin yang diperlukan.",
