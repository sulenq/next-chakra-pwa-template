const translations = {
  ...
  "loading_save_new_password": {
    "title": "Simpan password baru",
    "description": "Sedang menyimpan password baru..."
  },
  "loading_sending_otp": {
    "title": "Mengirim OTP",
    "description": "Sedang mengirim OTP ke email anda..."
  },
  "loading_signin": {
    "title": "Sign in",
  ...
  "loading_verify_otp": {
    ...
    "description": "Sedang memverifikasi OTP..."
  },
  ...
  "msg_permissions_denied_helper": "Jika ingin memberikan akses kembali, silakan buka setelan situs/izin aplikasi pada browser Anda, cari izin terkait, lalu ubah nilainya secara manual di sana.",
  "msg_permissions_granted_helper": "Jika ingin menonaktifkannya, silakan buka setelan situs/izin aplikasi pada browser Anda, cari izin terkait, lalu ubah nilainya secara manual di sana.",
  "msg_rendering_pdf": "Menyiapkan pratinjau halaman...",
  ...
  "msg_settings_index_route": "Pilih menu pengaturan.",
  ...
  "msg_welcome_12": "Semoga harimu ringan dan lancar.",
  "msg_welcome_13": "Semoga harimu membawa banyak kemudahan.",
  "msg_welcome_14": "Semoga harimu penuh inspirasi.",
  "msg_welcome_15": "Semoga harimu memberi banyak hal baik.",
  "msg_welcome_16": "Semoga langkahmu hari ini dimudahkan.",
  "msg_welcome_2": "Semoga aktivitasmu hari ini menyenangkan.",
  "msg_welcome_3": "Semoga harimu produktif.",
  "msg_welcome_4": "Semoga harimu penuh kemudahan.",
  "msg_welcome_5": "Semuanya semoga berjalan baik.",
  "msg_welcome_6": "Semoga harimu menyenangkan.",
  "msg_welcome_7": "Semoga harimu membawa hasil yang baik.",
  "msg_welcome_8": "Semoga aktivitasmu hari ini lancar.",
  "msg_welcome_9": "Semoga harimu penuh energi positif.",
  "msg_welcome_to_the_app": "Selamat datang di ${appName}",
  ...
  "perm_denied_permanent": "Diblokir",
  "perm_denied_temporary": "Ditolak Sesi Ini",
  "perm_granted_permanent": "Permanen",
  "perm_granted_temporary": "Sesi Ini (Temporer)",
  ...
  "settings_ambience_color": {
    "title": "Warna ambience",
    "description": "Warna yang memberikan nuansa warna sesuai dengan warna aksen yang sedang aktif"
  },
  ...
  "showing": "Menampilkan",
  "signin_history": "Riwayat sign in",
